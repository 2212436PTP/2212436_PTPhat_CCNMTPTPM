  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-24 text-center relative overflow-hidden">
      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <div className="h-56 w-56 rounded-full bg-emerald-100/70 blur-2xl animate-pulse" />
      </div>

      <div className="mb-6 flex justify-center">
        <div className="relative h-24 w-24">
          <div className="absolute inset-0 rounded-full bg-emerald-200 animate-ping" />
          <div className="absolute inset-2 rounded-full bg-emerald-500 flex items-center justify-center text-3xl text-white">
            ?
          </div>
        </div>
      </div>
